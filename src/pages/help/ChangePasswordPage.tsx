...
const ChangePasswordPage = (props: ChangePasswordPageProps) => {
  ...
  const { onSuccess, onRemembered } = props
  ...
  return (
    ...
    >
      ...
      />
      <Text
        style={[TextStyles.smallInputFeedback, styles.feedbackText, { opacity: newPasswordValid === false ? 1 : 0 }]}
      >
      ...
      />
      <Text style={[TextStyles.smallInputFeedback, styles.feedbackText, { opacity: confirmNewPasswordValid === false ? 1 : 0 }]}>
