...
export type UserPreviewQuery = { __typename?: 'Query', user?: { __typename?: 'User', id: number, username: string, followers: number, following: number, collections: Array<{ __typename?: 'FragranceCollection', id: number, name: string, fragrances: Array<{ __typename?: 'Fragrance', images: Array<{ __typename?: 'FragranceImage', id: number, url: string }> }>, user: { __typename?: 'User', username: string } }>, reviews: Array<{ __typename?: 'FragranceReview', id: number, rating: number, review: string, votes: number, author: string, myVote?: boolean | null, dCreated: Date, dModified: Date }>, likes: Array<{ __typename?: 'Fragrance', id: number, brand: string, name: string, images: Array<{ __typename?: 'FragranceImage', id: number, url: string }>, vote: { __typename?: 'FragranceVote', id: number, likes: number, dislikes: number, myVote?: boolean | null } }> } | null };
